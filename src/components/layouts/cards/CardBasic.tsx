...
const CardBasic = () => {
     return (
          <div className='grid grid-cols-1 gap-y-10 w-full px-10 md:grid-cols-2 md:gap-4 
          lg:grid-rows-2 lg:grid-cols-3 lg:gap-4 transition-all duration-1000'>
               {
                         ...
                         const cardClass =
                              index === 0 ?
                                   ...
                                   index === 3 ? 'lg:col-span-2' :
                                        'col-span-1 h-60 w-full';

                         return (
                              <div key={index} className={`relative h-60 rounded-xl ${cardClass}`}>
                                   <div className=''>
                                        <img className='absolute -z-10 w-full h-full object-cover rounded-xl'
                                             src={item.img}
                                             alt={`card-${index}`} />
                                        <div className='bg-gradient-to-t from-tertiary/80 to-transparent from-40% to-80% absolute inset-0 rounded-xl' />
                                   </div>
